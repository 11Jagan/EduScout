...
export default function Navbar() {
  ...
  return (
    <header className="sticky top-4 z-50 mx-4 md:mx-8 xl:mx-auto max-w-7xl bg-white/70 backdrop-blur-xl border border-white shadow-[0_8px_30px_rgb(0,0,0,0.04)] rounded-2xl mb-8">
        ...
        <div className="flex items-center justify-between h-16">
          ...
          <Link href="/" className="flex items-center gap-2.5 group">
            ...
            <span className="text-xl font-bold text-gray-900">
              Edu<span className="text-blue-700">Scout</span>
            </span>
          </Link>
          ...
          <div className="flex items-center gap-3">
            <Link
              href="/compare"
              className="hidden md:flex items-center gap-2 px-3 py-2 bg-blue-50 text-blue-700 rounded-lg text-sm font-medium hover:bg-blue-100 transition-colors"
            >
            ...
            {navLinks.map(({ href, label, icon: Icon }) => (
              ...
              >
                ...
                {href === "/compare" && compareList.length > 0 && (
                  <span className="ml-auto w-5 h-5 bg-blue-700 text-white rounded-full text-xs flex items-center justify-center font-bold">
                    {compareList.length}
                  </span>
                )}
              </Link>
